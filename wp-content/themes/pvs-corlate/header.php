        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container"><div class="row">
				...
				<div class="col-md-6"><?php 
					...
					//wp_nav_menu($args);
					?></div>
				<div class="col-md-4"><div class="right">
					<div class="col-md-4 col-sm-1 col-xs-2 btn-group dropdown"  id="cart_desktop"></div>
					...
					<div class="col-md-4 col-sm-1 col-xs-2"><div  class="header-members dropdown">
