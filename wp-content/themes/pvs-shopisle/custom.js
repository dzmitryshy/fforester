function make_cart() {	
	...
	if(total!=0) {
		cart_text+="<tr><td colspan=\"5\">"+cart_word_total+": <b>"+cart_currency1+total.toFixed(2)+" "+cart_currency2+"</b></td></tr></tbody></table><div class=\" text-right cart_buttons\"><a href='"+cart_site_root+"cart/' class=\"btn btn-group btn-success btn-sm\">"+cart_word_view+"</a> <a href='"+cart_site_root+"checkout/' class=\"btn btn-group btn-primary btn-sm\">"+cart_word_checkout+"</a></div></div>";
	}
...
$(document).ready(function() {
	...
	$newElement2.attr({
   	 	id : "lightbox_menu_error"
	});
	
	var $newElement3 = $(document.createElement("div"));
	$newElement3.appendTo($("body"));

	$newElement3.attr({
   	 	id : "lightbox"
	}).css("top", "0px").css("left", "0px").css("position", "absolute").css("zindex", "1000").css("display", "none");
