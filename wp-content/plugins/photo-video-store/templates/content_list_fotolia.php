...
if ( $flow == 1 ) {
	if ( @$prints_flag and $pvs_global_settings["fotolia_prints"] ) {
...
if ( isset( $_REQUEST["stock_type"] ) ) {
	if ( $_REQUEST["stock_type"] == "" ) {
		$url = 'https://api.fotolia.com/Rest/1/search/getSearchResults?search_parameters[filters][content_type:all]=1';
	}
	...
	if ( $_REQUEST["stock_type"] == "photo" or $_REQUEST["stock_type"] ==
		...
		$url = 'https://api.fotolia.com/Rest/1/search/getSearchResults?search_parameters[filters][content_type:' .
			$_REQUEST["stock_type"] . ']=1';
	}

	if ( $_REQUEST["stock_type"] == "videos" ) {
		$url = 'https://api.fotolia.com/Rest/1/search/getSearchResults?search_parameters[filters][content_type:video]=1';
	}
} else
{
	$url = 'https://api.fotolia.com/Rest/1/search/getSearchResults?search_parameters[filters][content_type:all]=1';
