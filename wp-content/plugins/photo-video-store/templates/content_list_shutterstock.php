...
if ( $flow == 1 ) {
	if ( @$prints_flag and $pvs_global_settings["shutterstock_prints"] ) {
...
//Color
if ( @$_REQUEST["color"] != "" and @$_REQUEST["color"] != "FFFFFF" and @$_REQUEST["stock_type"] != "music" and @$_REQUEST["stock_type"] !=
	"videos" ) {
