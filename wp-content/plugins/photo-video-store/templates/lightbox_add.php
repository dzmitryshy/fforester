...
if ( is_user_logged_in() ) {
	...
	$ajax_result = array( "result_code" => pvs_word_lang( "the file was added to the lightbox" ) );
} else
{
	$ajax_result = array( "result_code" => pvs_word_lang( "You should login to use the option" ) );
}
