...
jQuery.preloadImages(print_image);
...
<div class="row">
    <div class="col-lg-6 col-md-6 panel_left2">	
          ...
          <div class="row">
      	<div class="col-lg-6 col-md-6 col-sm-6 toleft"><?php echo($pvs_theme_content[ 'author' ]);?> </div>
       	<div class="col-lg-6 col-md-6 col-sm-6 toleft"><b>ID : <?php echo($pvs_theme_content[ 'id' ]);?></b></div>
       </div>
...
<h3><?php echo(pvs_word_lang("File details"));?></h3>
    ...
    <div class="col-lg-6 col-md-6 panel_right2"  style="padding-left:50px">
						...
						jQuery(document).ready(function() {
							 jQuery("#slide1").slider({
								...
								slide: function( event, ui ) {
											jQuery( "#print_size" ).val(ui.value);
											show_image();
										}
							});
						});
