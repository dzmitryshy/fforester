...
<script>
	jQuery(function() { 
			...
			jQuery('#map_canvas').gmap({'zoom': 2, 'disableDefaultUI':true,'zoomControl': true,'panControl': true,'mapTypeControl': true,'scaleControl': true,'streetViewControl': true,
...
?>'
		...
		*/
		...
		if ( $key != "category" ) {
?>
		jQuery('#map_canvas').gmap('openInfoWindow', {'content': '<a href="<?php
...
?>
	jQuery(this).gmap('set', 'MarkerClusterer', new MarkerClusterer(map, jQuery(this).gmap('get', 'markers')));
			});
