...
function add_friend(value) {
    jQuery.ajax({
		type:'POST',
		url:'<?php echo (site_url( ) );?>/friends-add/',
		data:'friend=' + value,
		success:function(data){
			document.getElementById('friendbox').innerHTML = data;
		}
	});
}
...
function delete_friend(value) {
    jQuery.ajax({
		type:'POST',
		url:'<?php echo (site_url( ) );?>/friends-delete/',
		data:'friend=' + value,
		success:function(data){
			document.getElementById('friendbox').innerHTML = data;
		}
...
function testimonials_show(value) {
    jQuery.ajax({
		type:'POST',
		url:'<?php echo (site_url( ) );?>/user-testimonials-content/',
		data:'login=' + value,
		success:function(data){
			document.getElementById('testimonialscontent').innerHTML = data;
		}
	});
}
...
<script>
    ...
    function vote_rating(id,score)
    {
		...
		?>
    		jQuery.ajax({
				type:'POST',
				url:'<?php echo (site_url( ) );?>/vote-user/',
...
<div class="row">
	<div class="col-xl-3 col-lg-3 col-md-3 panel_left">
...
<?php }?>
		...
		<div class="col-xl-9 col-lg-9 col-md-9 panel_right">
