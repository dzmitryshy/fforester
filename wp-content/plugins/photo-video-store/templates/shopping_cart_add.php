...
if ( ! wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-shopping-cart-add' ) ) {	
	exit();
}
  ...
  <div class="modal-body">
	<div class="row">
    	<div class="col-lg-3 col-md-3">
			<img src="' . $size_result["thumb"] . '" style="max-width:120px">
	</div>
		<div class="col-lg-9 col-md-9">
			<h5>' . $publication_title . ' &mdash; #' . $params["publication_id"] . '</h5>
