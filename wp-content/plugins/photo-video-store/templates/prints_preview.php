...
$prints_content = file_get_contents( pvs_upload_dir() . "/" . $site_template_url . "prints_preview.tpl" );

$sql = "select title,description from " . PVS_DB_PREFIX . "prints where id_parent=" . $id;
$rs->open( $sql );
if ( ! $rs->eof ) {
...
$ajax_result = array( "prints_content" => $prints_content );
