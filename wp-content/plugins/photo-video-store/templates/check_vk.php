...
if ( $pvs_global_settings["auth_vkontakte"] ) {
	...
	if ( ! isset( $_GET["code"] ) ) {
		$url = "https://oauth.vk.com/authorize?client_id=" . $client_id .
			"&scope=&redirect_uri=" . $my_url . "&response_type=code&v=5.73";
		header( "location:" . $url );
