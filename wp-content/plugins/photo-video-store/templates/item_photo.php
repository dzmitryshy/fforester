 ...
 <div class="clearfix"></div>
    ...
    <div class="col-lg-6 col-md-6 panel_left2" style="min-width:500px">
			...
			<?php if ($pvs_theme_content[ 'flag_colors' ] ) {?>
				<h3><?php echo(pvs_word_lang("Color"));?></h3>
    ...
    <div class="col-lg-6 col-md-6 summary entry-summary panel_right2">
      <div class="row">
       ...
       <hr />
        ...
        <ul  class="tabs" data-persist="true">
          ...
          <li><a href="#exif_content" onclick="exif_show(<?php echo($pvs_theme_content[ 'id' ]);?>);">EXIF</a></li>
