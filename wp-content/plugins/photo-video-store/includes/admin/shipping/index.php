...
//Change
if ( @$_REQUEST["action"] == 'change' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-shipping-change' ) )
{
	include ( "change.php" );
}

//Add
if ( @$_REQUEST["action"] == 'add' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-shipping-add' ) )
{
	include ( "add.php" );
}

//Delete
if ( @$_REQUEST["action"] == 'delete' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-shipping-delete' ) )
{
	include ( "delete.php" );
}
...
?>
		...
		<?php wp_nonce_field( 'pvs-shipping-change' ); ?>
...
?>&action=delete&id=<?php
			echo $rs->row["id"]
?>&_wpnonce=<?php echo wp_create_nonce('pvs-shipping-delete'); ?>'><?php
