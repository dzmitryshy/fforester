...
{
	jQuery("#regions_list2 input:checkbox").each(function(){this.checked = !this.checked && !this.disabled;});
}
...
function show_dollar()
{
	...
	{
		jQuery('.dollar_percent').html("%");
		jQuery('.dollar_percent2').html("%");
	}
	else
	{
		jQuery('.dollar_percent').html("$");
...
function check()
{
	...
	for(i=0;i<item_mass.length;i++)
	{
		...
		{
			jQuery('#'+id11).css({'border-color':'#a8a8a8'});
			jQuery('#'+id12).css({'border-color':'#a8a8a8'});
		}
	}
	...
	for(i=0;i<item_mass.length;i++)
	{
		...
		{
			jQuery('#'+id11).css({'border-color':'#d70c0c'});
			jQuery('#'+id12).css({'border-color':'#d70c0c'});
			jQuery('#'+id12).focus();
			flag=false;
		}
		...
		{
			jQuery('#'+id12).css({'border-color':'#d70c0c'});
			jQuery('#'+id21).css({'border-color':'#d70c0c'});
			jQuery('#'+id21).focus();			
			flag=false;
		}
...
<?php wp_nonce_field( 'pvs-shipping-add' ); ?>
<?php
