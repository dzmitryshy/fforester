...
?>
	...
	<script>
		function build_scheme() {
			...
			jQuery("#print_h").css("top", y1);
			jQuery("#print_h").css("left", 0);
			
			jQuery("#print_v").css("top", 0);
			jQuery("#print_v").css("left", x1);
			
			jQuery("#print").css("top", y1);
			jQuery("#print").css("left", x1);
			
			jQuery("#top_left").css("top", -5);
			jQuery("#top_left").css("right", jQuery('#print_preview').width()+10);
			
			jQuery("#bottom_left").css("top", jQuery('#print_preview').height()+5);
			jQuery("#bottom_left").css("left", -3);
			
			jQuery("#bottom_right").css("top", jQuery('#print_preview').height()+5);
			jQuery("#bottom_right").css("left", jQuery('#print_preview').width()-15);
			
			if(x1 != 0)
			{
				jQuery("#print_x1").css("top", jQuery('#print_preview').height()+5);
				jQuery("#print_x1").css("left", x1-10);
				jQuery("#print_x1").html(x1_original);
			}
			
			if(x2 != 0)
			{
				jQuery("#print_x2").css("top", jQuery('#print_preview').height()+5);
				jQuery("#print_x2").css("left", x2-10);
				jQuery("#print_x2").html(x2_original);
			}
			
			if(y1 != 0)
			{
				jQuery("#print_y1").css("top", y2-7);
				jQuery("#print_y1").css("right", jQuery('#print_preview').width()+10);
				jQuery("#print_y1").html(<?php echo $photo_height
?>-y2_original);
			}
			
			if(y2 != 0)
			{
				jQuery("#print_y2").css("top", y1-7);
				jQuery("#print_y2").css("right", jQuery('#print_preview').width()+10);
				jQuery("#print_y2").html(<?php echo $photo_height
?>-y1_original);
			}
