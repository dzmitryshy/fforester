...
//Change
if ( @$_REQUEST["action"] == 'change' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-checkout-change' ) )
{
	include ( "change.php" );
}

//Change terms
if ( @$_REQUEST["action"] == 'change_terms' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-checkout-change-terms' ) )
{
...
<div class="subheader_text">
	...
	<?php wp_nonce_field( 'pvs-checkout-change' ); ?>
	<?php
...
?>&action=new&_wpnonce=<?php echo wp_create_nonce('pvs-checkout-add'); ?>"><i class="icon-file icon-white fa fa-plus"></i>&nbsp; <?php
...
?>
	...
	<?php wp_nonce_field( 'pvs-checkout-change-terms' ); ?>
