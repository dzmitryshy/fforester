...
<button class="btn btn-success toright" data-toggle="modal" data-target="#modal_window"><i class="icon-envelope icon-white fa fa-plus"></i>&nbsp; <?php echo pvs_word_lang( "new message" )?></button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
		...
		<?php echo pvs_word_lang( "new message" )?>
      </div>
...
<?php
	$property_value = pvs_get_admin_notifications( 'messages', 'value' );
	while ( ! $rs->eof ) {
		$cl3 = "";
		$cl_script = "";
