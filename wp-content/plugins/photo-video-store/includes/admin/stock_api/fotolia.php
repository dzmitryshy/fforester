...
<div class="subheader_text">
	...
	<?php wp_nonce_field( 'pvs-fotolia' ); ?>
...
?>&d=3&action=fotolia_categories&_wpnonce=<?php echo wp_create_nonce('pvs-fotolia'); ?>" class="btn btn-default" style="margin-top:2px"><i class="fa fa-refresh"></i> <?php
