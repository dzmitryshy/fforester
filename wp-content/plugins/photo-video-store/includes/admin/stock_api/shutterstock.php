...
<div class="subheader_text">
	...
	<?php wp_nonce_field( 'pvs-shutterstock' ); ?>
...
?>&d=2&action=shutterstock_categories&_wpnonce=<?php echo wp_create_nonce('pvs-shutterstock'); ?>" class="btn btn-default" style="margin-top:2px"><i class="fa fa-refresh"></i> <?php
