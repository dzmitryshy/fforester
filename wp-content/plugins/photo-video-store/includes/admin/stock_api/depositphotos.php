...
<div class="subheader_text">
	...
	<?php wp_nonce_field( 'pvs-depositphotos' ); ?>
...
?>&d=4&action=depositphotos_categories&_wpnonce=<?php echo wp_create_nonce('pvs-depositphotos'); ?>" class="btn btn-default" style="margin-top:2px"><i class="fa fa-refresh"></i> <?php
