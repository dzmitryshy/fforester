...
<div class="subheader_text">
	...
	<?php wp_nonce_field( 'pvs-bigstockphoto' ); ?>
...
?>&d=6&action=bigstockphoto_categories&_wpnonce=<?php echo wp_create_nonce('pvs-bigstockphoto'); ?>" class="btn btn-default" style="margin-top:2px"><i class="fa fa-refresh"></i> <?php
