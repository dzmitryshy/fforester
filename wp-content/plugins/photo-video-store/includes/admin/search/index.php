...
//Delete
if ( @$_REQUEST["action"] == 'delete' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-search-delete' )  )
{
	include ( "delete.php" );
}
...
<a class="btn btn-danger toright" href="<?php echo(pvs_plugins_admin_url('search/index.php'));?>&action=delete&_wpnonce=<?php echo wp_create_nonce('pvs-search-delete'); ?>"><i class="icon-trash icon-white"></i> <?php echo pvs_word_lang( "remove all" )?></a>
