...
//Delete
if ( @$_REQUEST["action"] == 'delete' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-payments-delete' ) )
{
	include ( "delete.php" );
}
?>
...
<?php wp_nonce_field( 'pvs-payments-delete' ); ?>
...
<?php
	$property_value = pvs_get_admin_notifications( 'payments', 'value' );
	while ( ! $rs->eof ) {
