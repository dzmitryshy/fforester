...
function bulk_change_price(value) {
	jQuery(".prints_price").val(value);
}

function bulk_change_quantity(value) {
	if(value == -1) {
		jQuery("#quantity").css("display","none");
		jQuery(".text_quantity").css("display","none");
	}
	else {
		jQuery("#quantity").css("display","block");
		jQuery(".text_quantity").css("display","block");
	}
	
	jQuery(".select_quantity").val(value);
}

function bulk_change_quantity2(value) {
	jQuery(".text_quantity").val(value);
}
</script>
