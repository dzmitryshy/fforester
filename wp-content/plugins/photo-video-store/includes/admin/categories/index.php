...
//Add
if ( @$_REQUEST["action"] == 'add'  and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-categories-add' ) )
{
	include ( "add.php" );
}

//Delete
if ( @$_REQUEST["action"] == 'delete'  and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-categories-delete' . $_GET["id"] ) )
{
	include ( "delete.php" );
}

//Delete thumb
if ( @$_REQUEST["action"] == 'delete_thumb' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-categories-delete-thumb' ) )
{
