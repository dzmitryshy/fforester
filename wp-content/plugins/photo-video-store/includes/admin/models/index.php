...
//Add
if ( @$_REQUEST["action"] == 'add' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-models-add' ) )
{
	include ( "add.php" );
}

//Change
if ( @$_REQUEST["action"] == 'change' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-models-change' ) )
{
	include ( "change.php" );
}

//Delete
if ( @$_REQUEST["action"] == 'delete' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-models-delete' ) )
{
	include ( "delete.php" );
}
...
?>
		...
		<?php wp_nonce_field( 'pvs-models-change' ); ?>
...
?>&action=delete&id=<?php
			echo $rs->row["id_parent"]
?>&_wpnonce=<?php echo wp_create_nonce('pvs-models-delete'); ?>'><?php
