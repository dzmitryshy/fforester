...
function add_range(value)
{
	...
	jQuery("#ranges_"+value+" > tbody").append("<tr id='tr"+value+item_id+"'><td><input type='text' name='"+value+item_id+"_title'  id='"+value+item_id+"_title' value='New option' style='width:150px;'></td><td><input type='text' name='"+value+item_id+"_value'  id='"+value+item_id+"_value' value='' style='width:150px;'></td><td><select name='"+value+item_id+"_adjust' id='"+value+item_id+"_adjust' style='width:70px;'><option value='1' selected>+</option><option value='-1'>-</option></select></td><td><input type='text' name='"+value+"_price"+item_id+"' id='"+value+"_price"+item_id+"' value='0' style='width:50px;'></td><td><input type='button' class='btn' value='<?php
...
<?php wp_nonce_field( 'pvs-options-add' ); ?>
<?php
if ( isset( $_GET["id"] ) )
{
