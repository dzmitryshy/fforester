...
//Delete
if ( @$_REQUEST["action"] == 'delete' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-contacts-delete' ) )
{
	include ( "delete.php" );
}
...
<?php wp_nonce_field( 'pvs-contacts-delete' ); ?>
...
<?php
	$property_value = pvs_get_admin_notifications( 'contacts', 'value' );
	while ( ! $rs->eof ) {
		$cl3 = "";
		$cl_script = "";
