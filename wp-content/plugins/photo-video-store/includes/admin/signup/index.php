...
if ( @$_REQUEST["action"] == 'change_fields' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-signup-change-fields' ) )
{
	include ( "change_fields.php" );
}

if ( @$_REQUEST["action"] == 'change' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-signup-change' ) )
{
	include ( "change.php" );
}
...
<h4><?php echo pvs_word_lang( "Sign up fields" )?></h4>
	...
	<?php wp_nonce_field( 'pvs-signup-change-fields' ); ?>
...
<?php wp_nonce_field( 'pvs-signup-change' ); ?>
