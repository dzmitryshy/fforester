...
<?php wp_nonce_field( 'pvs-prices-add' ); ?>
...
?></b></th>
<th><b><?php echo pvs_word_lang( "contact us to get the price" )?></b></th>
<th><b><?php
...
<td align="center"><input type="checkbox" name="contacts" value="1"></td>
...
<?php wp_nonce_field( 'pvs-prices-change' ); ?>
<table class="wp-list-table widefat fixed striped posts">
<thead>
<tr>
...
?>></td>
<td align="center"><input name="contacts<?php
			echo $dr->row["id_parent"]
?>" type="checkbox" <?php
			if ( $dr->row["contacts"] == 1 )
			{
				echo ( "checked" );
			}
?> value="1"></td>
