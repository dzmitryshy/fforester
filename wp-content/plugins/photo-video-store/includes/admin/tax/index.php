...
//Change
if ( @$_REQUEST["action"] == 'change' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-tax-change' ) )
{
	include ( "change.php" );
}

//Add
if ( @$_REQUEST["action"] == 'add' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-tax-add' ) )
{
	include ( "add.php" );
}

//Delete
if ( @$_REQUEST["action"] == 'delete' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-tax-delete' ) )
{
	include ( "delete.php" );
}
...
?>
		...
		<?php wp_nonce_field( 'pvs-tax-change' ); ?>
...
?>&action=delete&id=<?php
			echo $rs->row["id"]
?>&_wpnonce=<?php echo wp_create_nonce('pvs-tax-delete'); ?>'><?php
