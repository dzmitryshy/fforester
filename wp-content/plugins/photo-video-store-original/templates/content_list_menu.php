...
?>
	...
	<div class="search_text">
		<div class="input-group input-group-md">
			<input name="search" type="text" class="form-control" onClick="this.value=''">
			<span class="input-group-btn">
			<button class="btn btn-default" style="margin-top:0px;min-width:50px"><i class="fa fa-search"></i></button>
			</span>
		</div>
	</div>
